...
namespace RootMotion.Dynamics {
	...
	public class Muscle {
		...
		public void UpdateAnchor(bool supportTranslationAnimation) {
            ...
            if (connectedBodyTransform == null) //CE adding 7-6-2018 to debug
            {
                Debug.Log("connectedBodyTransform is null, when working with joint.connectedbody " + joint.connectedBody.name + " and connectedBodyTarget " + connectedBodyTarget.name + ".");
            }
